...
<body>
    ...
    <main class="container">
        ...
        <section id="crossfield">
            ...
            <div class="grid-2">
                <div class="card">
                    <h4 class="font-bold text-success mb-2">1. Free Self-Serve Directly Signals Immediate Buildability</h4>
                ...
                <div class="card">
                    <h4 class="font-bold text-primary mb-2">3. API Surface Richness Predicts Integration Viability</h4>
                    <p class="text-sm text-slate-600 mb-2">
...
python analysis/generate_pattern_analysis.py</code></pre>
        ...
        <footer style="border-top: 1px solid var(--color-border); padding-top: 2rem; margin-top: 4rem; text-align: center; color: var(--color-text-subtle); font-size: 0.88rem;">
            ...
            <p class="mt-2 text-xs">Generated: {datetime.now(timezone.utc).strftime('%B %d, %Y')} · DeepMind Antigravity</p>
        </footer>
